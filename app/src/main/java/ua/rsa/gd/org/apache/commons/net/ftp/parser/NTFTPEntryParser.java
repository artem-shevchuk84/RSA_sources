...
package ua.rsa.gd.org.apache.commons.net.ftp.parser;
import java.text.ParseException;

import ua.rsa.gd.org.apache.commons.net.ftp.Configurable;
import ua.rsa.gd.org.apache.commons.net.ftp.FTPClientConfig;
...
public class NTFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
    ...
    public FTPFile parseFTPEntry(String entry)
    {
        ...
        if (matches(entry))
        {
            ...
            if (null == name || name.equals(".") || name.equals("build/generated/res/resValues"))
            {
                return (null);
            }
            f.setName(name);
