...
import ru.by.rsa.external.javadbf.DBFReader;
import ru.by.rsa.external.javadbf.DBFWriter;
import ru.by.rsa.external.javadbf.JDBFException;
import ru.by.rsa.external.javadbf.JDBField;
import ru.by.rsa.external.opencsv.CSVReader;
...
public class RsaDb
{
	...
	public static void fromLzma(Context context, String inputFile, String outputFile) throws Exception
	{
		...
		ru.by.rsa.external.sevenzip.compression.lzma.Decoder decoder = new ru.by.rsa.external.sevenzip.compression.lzma.Decoder();
	...
	public static void toLzma(Context context, String inputFile, String outputFile) throws Exception
	{
		...
		ru.by.rsa.external.sevenzip.compression.lzma.Encoder encoder = new ru.by.rsa.external.sevenzip.compression.lzma.Encoder();
