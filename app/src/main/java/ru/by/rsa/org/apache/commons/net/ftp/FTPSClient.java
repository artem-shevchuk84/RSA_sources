...
import ru.by.rsa.org.apache.commons.net.util.SSLContextUtils;
import ru.by.rsa.org.apache.commons.net.util.TrustManagerUtils;

/**
 * FTP over SSL processing. If desired, the JVM property -Djavax.net.debug=all can be used to
 * see wire-level SSL details.
 *
 * @version $Id: FTPSClient.java 1299238 2012-03-10 17:12:28Z sebb $
 * @since 2.0
 */
