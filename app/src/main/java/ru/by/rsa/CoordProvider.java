...
public class CoordProvider extends ContentProvider
{
	...
	public static final Uri CONTENT_URI			= Uri.parse(
											"content://ru.by.rsa.CoordProvider/_coord");
	...
	static {
		...
		mUriMatcher.addURI("ru.by.rsa.CoordProvider", CoordDbHelper.TABLE_NAME, URI_CODE);
		mUriMatcher.addURI("ru.by.rsa.CoordProvider", CoordDbHelper.TABLE_NAME + "/#", URI_CODE_ID);
